...
- [Mongoose Recipes](#mongoose-recipes)
  ...
  - [Setting Up Your Express Server](#setting-up-your-express-server)
    - [Running and Testing Your Server](#running-and-testing-your-server)
  ...
  - [Creating Models with the Mongoose Schema Class](#creating-models-with-the-mongoose-schema-class)
    - [Mapping Your Application with an ERD](#mapping-your-application-with-an-erd)
    - [Creating Your User Model](#creating-your-user-model)
    - [Creating Your Recipe Model](#creating-your-recipe-model)
  - [Setting Up CRUD Operations](#setting-up-crud-operations)
    - [Folder Structure](#folder-structure)
    - [Following a Repeatable Pattern for Creating Each CRUD Operation](#following-a-repeatable-pattern-for-creating-each-crud-operation)
  - [Auth CRUD Functionality](#auth-crud-functionality)
    - [Registering a User](#registering-a-user)
    - [Signing In A User](#signing-in-a-user)
    - [Signing Out A User](#signing-out-a-user)
  - [User CRUD Functionality](#user-crud-functionality)
    - [Getting a User's Profile](#getting-a-users-profile)
    - [Updating a User's Password](#updating-a-users-password)
  - [Recipe CRUD Functionality](#recipe-crud-functionality)
    - [Creating a Recipe](#creating-a-recipe)
    - [Getting All Recipes](#getting-all-recipes)
  ...
  - [Creating Your EJS Views](#creating-your-ejs-views)
    - [Home Page \& Partials](#home-page--partials)
    - [Sign Up Page](#sign-up-page)
    - [Thank You Page](#thank-you-page)
    - [Sign In Page](#sign-in-page)
    - [User Profile Page](#user-profile-page)
    - [Update Password Page](#update-password-page)
    - [Confirmed Page](#confirmed-page)
    - [All Recipes Page](#all-recipes-page)
    - [Show Recipe Page](#show-recipe-page)
    - [New Recipe Page](#new-recipe-page)
    - [Edit Recipe Page](#edit-recipe-page)
    - [Delete Recipe Confirm Page](#delete-recipe-confirm-page)
